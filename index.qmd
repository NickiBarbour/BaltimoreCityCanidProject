...
![](images/coyote.png){fig-cap="Coyote in a MD city. Photo from Maryland Fur Trappers."}
...
![](images/CanidHealthFeedbackLoop.png){fig-cap="Positive feedback loop between urbanization and canid health. Canids in urban areas may have a higher proportion of nuisance rodents in their diet, which may have higher concentrations of poisons (rodenticides) that can bioaccumulate and put canids at risk of disease. Diseased canids may have altered behavior, including being more active during the day and more likely to cross busy roads." fig-align="center"}
...
![](images/cameratrap.png){fig-cap="Wildlife camera attached to a tree. Photo from UWIN." fig-align="center"}
