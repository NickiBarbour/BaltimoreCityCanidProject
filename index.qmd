...
```{=html}
<img src="images/BCCP_Banner.png" alt="Baltimore City Canid Project Banner" style="width:100%; border-radius:8px; margin-bottom: 20px;">
```
...
This study will be part of a national study on urban wildlife, the [Urban Wildlife Information Network (UWIN)](https://www.urbanwildlifeinfo.org/). UWIN protocols will be used to collect data, with cameras being put out for about a month in April, July, October, and December. This will also be a student-involved project, and both undergraduate and graduate students at Towson University will be helping to collect and analyze data!
